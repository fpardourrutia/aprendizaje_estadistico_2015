...
Ejemplo de cálculo manual de validación cruzada
---
...
ggplot(error_2, aes(x=error_prueba, y=valor, colour=error)) + geom_point() +
  geom_abline()+xlim(c(5,9))
```
...
selec_lista <- lapply(1:300, function(k){
  ...
  #mods <- glmnet(x=x, 
  #                    y=dat_entrena$y, alpha=0.5, lambda=lambdas)
...
Nótese que validación cruzada tiende a seleccionar modelos cercanos
