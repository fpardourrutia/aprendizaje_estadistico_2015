...
```{r}
control <- rpart.control(maxdepth=5, xval=2, cp=0)
...
Podemos ver parte de los primeros dos árboles:
```{r}
...
el predictor del bagging de árboles se hace por mayoría de votos
de los árboles integrantes:
